...
def build_report(df):
    ...
    report_lines = []
    report_lines.append("市場＋權證資金流雷達 v0.7")
...
def main():
    ...
    print(report)
    df.to_csv("market_warrant_flow_raw_v07.csv", index=False, encoding="utf-8-sig")
    market_vol_top.to_csv("market_volume_top10_v07.csv", index=False, encoding="utf-8-sig")
    market_amt_top.to_csv("market_amount_top10_v07.csv", index=False, encoding="utf-8-sig")
