...
# -*- coding: utf-8 -*-
"""
US Market After-hours Radar v0.5
...
def save_csv(strong_top: pd.DataFrame, weak_top: pd.DataFrame, inflow_sector_top: pd.DataFrame):
    strong_top.to_csv("us_strong_top10_v05.csv", index=False, encoding="utf-8-sig")
    weak_top.to_csv("us_weak_top10_v05.csv", index=False, encoding="utf-8-sig")
    inflow_sector_top.to_csv("us_inflow_sector_top10_v05.csv", index=False, encoding="utf-8-sig")
