...
def build_report(df):
    ...
    report_lines = []
    report_lines.append("📊 市場資金流雷達 v1.1")
...
def main():
    ...
    print(report)
    df.to_csv("market_flow_raw_v11.csv", index=False, encoding="utf-8-sig")
    market_vol_top.to_csv("market_volume_top10_v11.csv", index=False, encoding="utf-8-sig")
    market_amt_top.to_csv("market_amount_top10_v11.csv", index=False, encoding="utf-8-sig")
